...
function renderStateMap(region) {
  ...
  canvas.innerHTML = `<div class="brmap-svg" id="brmapStatesSvg" aria-hidden="true"></div>`;
  const host = document.getElementById('brmapStatesSvg');

  mountBrazilStatesMapInto(host, { region: region || currentRegion, activeUf: currentState }).then(() => {
